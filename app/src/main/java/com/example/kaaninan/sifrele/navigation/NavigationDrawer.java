package com.example.kaaninan.sifrele.navigation;
...
public class NavigationDrawer extends Drawable {
    ...
    /** Paths were generated with at this size for {@link NavigationDrawer#PATH_GEN_DENSITY}. */
    ...
    public NavigationDrawer(Resources resources) {
        this(resources, false);
    }

    public NavigationDrawer(Resources resources, boolean rounded) {
     ...
     * {@link NavigationDrawer#PATH_GEN_DENSITY}, no scaling needs to be done.
     */
